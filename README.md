...
Classifier model to perform this task. You can use Python ML libraries (e.g., scikit-learn) to write the program. Calculate the accuracy, precision, and recall for your data set.
...
data set. Display the confusion matrix and classification report (precision, recall,
f1-score). Python ML libraries (e.g., scikit-learn) can be used for this problem.
